	                           ...
	                           <div class="box-body">
									<table class="table table-bordered">
										<thead>
											<tr>
												<td>제목</td>
												<td><input type="text" class="form-text" name="title" style="width:500px;"required value="${board.title }" /></td>
											</tr>
										</thead>
										<tr>
											<td>작성자</td>
										...
										<tr>
											<td>내용</td>
											<td>
												<textarea id="editor" class="form-text" name="content" rows="20" style="width :100%" >${board.content}</textarea>
											</td>
										</tr>
										<tr>
											<td colspan="2">
